...
public class JPAController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Marque marque = new Marque(0, "dell");
			...
			System.out.println("_______ Passage par le DAO");
			Marque rechercher = marqueDao.rechercher("dell");
			System.out.println("recherche id 0 " + rechercher);
			//rechercher.setNomMarque("C'est plus un dell");
			System.out.println("End JPA controller");
